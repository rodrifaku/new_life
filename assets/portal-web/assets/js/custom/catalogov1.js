...
/* MÉTODO LLAMADO MEDIANTE BOTON EN LA PROPIEDAD onclick */
function  load(){
...
/* MÉTODO PARA LIMPIAR CARDS Y BORRAR EL CONTENIDO EN LA DIV CON id = catalogo */
function remove(){
    console.log('OBTENER DIV CON id = catalogo');
    const catalogoHTML = document.getElementById("catalogo");
    console.log('RENDERIZANDO O REESCRIBIENDO DIV CON id = catalogo BORRANDO SU CONTENIDO');
    /* SE REESCRIBE ESTRUCTURA DIV CON INNERHTML
